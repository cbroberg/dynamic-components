		...
		return (
			<div>
				...
				<FormBox>
					<AnimatedTop/>
					<AnimatedMiddle>
						<SingleLineLoader height="9px" width="157.29px" marginLeft="15px" marginTop="16.5px"/>
						<SingleLineLoader height="9px" width="113.29px" marginLeft="15px" marginTop="4.5px"/>
				...
				<FormBox>
					<AnimatedTop/>
					<AnimatedMiddle>
						<SingleLineLoader height="9px" width="130px" marginLeft="15px" marginTop="16.5px"/>
						<SingleLineLoader height="9px" width="145px" marginLeft="15px" marginTop="4.5px"/>
				...
				<FormBox>
					...
					<AnimatedMiddle>
						<SingleLineLoader height="9px" width="157.29px" marginLeft="15px" marginTop="16.5px"/>
						<SingleLineLoader height="9px" width="130px" marginLeft="15px" marginTop="4.5px"/>
						<SingleLineLoader height="9px" width="157.29px" marginLeft="15px" marginTop="4.5px"/>
						<SingleLineLoader height="11.33px" width="157.29px" marginTop="20px" marginBottom="7.5px" marginRight="15px" marginLeft="15px" borderRadius="2px"/>
					</AnimatedMiddle>
					<AnimatedBottom/>
