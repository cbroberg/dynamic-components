...
class OrganisationGroupUsers extends Component {
	...
	renderItemList = () => {
		...
		for (i = 0; i < 9; i++) {
			arr.push(
                <SingleItemContainer>
                    <SingleLineLoader height="23px" width="23px" marginTop="2px" margin-bottom="2px" marginLeft="32px" marginRight="36px" borderRadius="100px"/>
                    <SingleLineLoader height="9px" width="69px" marginTop="9px" marginRight="80px" borderRadius="4px"/>
                    <SingleLineLoader height="9px" width="34px" marginTop="9px" marginRight="59px" borderRadius="4px" animationDelay="0.15s" WKanimationDelay="0.15s"/>
                    <SingleLineLoader height="9px" width="66px" marginTop="9px" marginRight="233px" borderRadius="4px" animationDelay="0.25s" WKanimationDelay="0.25s"/>
                    <div>
                        &hellip;
                    </div>
                    <CheckboxContainer>
