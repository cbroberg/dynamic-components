...
export const StyledFormsCard = styled.div`
	float: left;
...
export const StyledFormsCardImage = styled.img`
	border-radius: 5px 5px 0 0;
	width: 100%;
`

export const StyledFormsCardContainer = styled.div`
	padding: 2px 16px;
`

export const StyledFormsCardHeader = styled.h4`
	text-align: center;
...
export const StyledFormsCardContent = styled.p`
	text-align: center;
	font-family: 'Source Sans Pro';
	font-size: 14px;
`
